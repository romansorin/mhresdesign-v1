...
<body>
    ...
    <!-- This is the code for the static header -->
    <div class="container-fluid no-padding">
        <div class="row">
            <div class="col-md-12 no-padding img-top">
                <?php
                /**
                 * [$results_header_image: Variable which is assigned the URL of the image from the database]
                 * @var [String]
                 *
                 * [$header_image->headerimg: Accesses the image store within the 'headerimg' column within the row]
                 */
                $results_header_image = $activity->fetchHeaderImage($pdo, 'activity');
    ...
    <!-- This is the code for a carousel/slideshow header -->
    <div class="container-fluid no-padding">
        ...
        <div class="container no-padding">
            <div class="row no-padding" id="activity-content">
                <div class="col-md-12 no-padding" id="main-activity-content">
                    <h2>Information</h2>
                    <?php
                    $results_info = $activity->fetchActivityInformation($pdo, 'activity');
                ...
                <div class="row">
                    <div class="col-md-6 no-padding">
                        <figure class="article-img" style="margin-left: 0px;">
                            ...
                            * @var [String] [$results_img: Variable which is assigned the URL of the image from the database]
                            *
                            * @var [String] [$article_image->articleimg: Accesses the image store within the 'articleimg' column within the row]
                            */
