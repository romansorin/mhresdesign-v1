...
<head>
    ...
    <title>REFUGE - Christian Student Group | Mentor High School</title>
        ...
        <div class="container no-padding">
            <div class="row no-padding" id="activity-content">
                <div class="col-md-12 no-padding" id="main-activity-content">
                    <h2>Information</h2>
                    <p>Refuge is a student-led Christian club. We believe that God the Father sent his Son, Jesus Christ, to save us from sin. As Christians, we are called to live like Christ as defined by both the Old and New Testament. We do all sorts of activities, including studying scripture, learning from dynamic speakers, reading books and articles, and discussing Christian movies. We have volunteered at the Project Hope Homeless Shelter, served children in need in conjunction with Five Loaves and fellowship of Christian Athletes, and sang Christmas Carols at Heartland of Mentor Nursing Home and Rehabilitation Center before Christmas. If you have any more ideas, we are always open to do even more! 
                    Everyone of all backgrounds and faiths are welcome! Make sure to bring friends! We meet every Monday in A-200 or air-conditioned A-212 from 230-4pm. Feel free to contact us through any means. Please send a message through remind or through email. Mr. Skilton (skilton@mentorschools.org) Mr. Steigerwald (steigerwald@mentorschools.org)</p>
                </div>
            </div>
        </div>
