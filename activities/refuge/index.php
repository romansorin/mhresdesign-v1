    ...
    <div class="container-fluid no-padding">
        <div class="row">
            <div class="col-md-12 no-padding img-top">
                <?php
                $results_header_image = $activity->fetchHeaderImage($pdo, 'REFUGE');
                foreach ($results_header_image as $header_image): ?>
                    <img class="d-block w-100 img-fit" src="<?=$header_image->headerimg;?>" alt="REFUGE header photo">
                <?php endforeach;?>
        ...
        <div class="container no-padding">
            <div class="row no-padding" id="activity-content">
                <div class="col-md-12 no-padding" id="main-activity-content">
                    <h2>Information</h2>
                    <?php
                    $results_info = $activity->fetchActivityInformation($pdo, 'REFUGE');
            ...
            <div class="container no-padding">
                <div class="row">
                    <div class="col-md-6 no-padding">
                        <figure class="article-img" style="margin-left: 0px;">
                            <?php
                            $results_image = $activity->fetchArticleImage($pdo, 'REFUGE', 1);
                    ...
                    <div class="col-md-6 no-padding">
                        <div class="content mr-left">
                            <?php
                            $results_title = $activity->fetchArticleTitle($pdo, 'REFUGE', 1);
                            ...
                            <?php
                            $results_content = $activity->fetchArticleContent($pdo, 'REFUGE', 1);
                            ...
                            <?php
                            $results_link = $activity->fetchArticleLink($pdo, 'REFUGE', 1);
                ...
                <div class="row">
                    <div class="col-md-6 no-padding">
                        <div class="content">
                            <?php
                            $results_title = $activity->fetchArticleTitle($pdo, 'REFUGE', 2);
                            foreach ($results_title as $title): ?>
                                <h3 class="article-title">
                                    <?=$title->title;?>
                                </h3>
                            ...
                            <?php
                            $results_content = $activity->fetchArticleContent($pdo, 'REFUGE', 2);
                            foreach ($results_content as $content): ?>
                                <p class="article-desc">
                                    <?=$content->content;?>
                                </p>
                            ...
                            <?php
                            $results_link = $activity->fetchArticleLink($pdo, 'REFUGE', 2);
                            foreach ($results_link as $link): ?>
                                <p class="article-link">
                                    <a href="<?=$link->link;?>">Article link</a>
                                </p>
                    ...
                    <div class="col-md-6 no-padding">
                        <figure class="article-img mr-left">
                            <?php
                            $results_link  = $activity->fetchArticleLink($pdo, 'REFUGE', 2);
                            $results_image = $activity->fetchArticleImage($pdo, 'REFUGE', 2);
                            foreach ($results_link as $link): ?>
                                <a href="<?=$link->link;?>">
                                <?php endforeach;?>
