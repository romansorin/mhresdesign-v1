        ...
        <div class="container no-padding">
            <div class="row no-padding" id="activity-content">
                <div class="col-md-12 no-padding" id="main-activity-content">
                    <h2>Information</h2>
                    <p>The MHS Cooking CLub is designed for students who love to cook and gather with friends over a great meal (or snack). The club meets once a month after school in the foods room. Our themes vary from month to month. While participating, students learn new skills while practicing previously learnes skills. Joining is a great way to learn to cook while deepening friendships and enjoying terrific food. We recently had a cooking tailgate party! Contact Suzanne Cahill to join. cahills@mentorschools.org

                    This is a fee based club ($15.00 yearly). 
                    Sign up is on Mondays and we meet on Tuesdays!</p>
                </div>
            </div>
        </div>
