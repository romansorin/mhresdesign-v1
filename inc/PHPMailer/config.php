...
function supportRequestMail($mail) {
// Server settings
...
function resetPasswordMail($mail) {
    $mail->SMTPDebug = 0; // Enable verbose debug output
    $mail->isSMTP(); // Set mailer to use SMTP
    $mail->Host       = 'smtp.gmail.com'; // Specify main and backup SMTP servers
    $mail->SMTPAuth   = true; // Enable SMTP authentication
...
// Recipients
    $mail->setFrom('noreply@mentorhigh.com', 'MHS Web Team');
    $mail->addAddress('rmaximsorin@gmail.com'); // Add a recipient
}//$recipientAddress